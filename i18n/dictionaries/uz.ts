...
const dict: Dictionary = {
  ...
  projectsNew: {
    ...
    subIndustryOtherOption: "Boshqa (qoʻlda kiriting)",
    subIndustryOtherPlaceholder: "Faoliyat turini aniqlashtiring",
    regionLabel: "Hudud",
    stageLabel: "Bosqich",
    amountLabel: "Miqdor, soʻm",
    ...
    loginRequiredTitle: "Shaxsiy kabinetga kiring",
    loginRequiredMessage: "Loyihani birjada joylashtirish va investorlar arizalarini shaxsiy kabinetda koʻrish uchun avval tizimga kiring yoki roʻyxatdan oʻting.",
    loginCta: "Kirish",
  },
  projectDetail: {
    ...
    contactPlaceholder: "Bogʻlanish uchun telefon yoki email",
  ...
  cabinet: {
    ...
    publicBadge: "Loyihalar birjasida",
    applicationsHeading: "Investorlar arizalari",
    viewApplications: "Koʻrish",
    hideApplications: "Yashirish",
    saveApplications: "Saqlash",
    noApplicationsYet: "Hozircha investorlardan ariza yoʻq.",
  },
  islamicGuide: {
    eyebrow: "Gid",
