...
const dict: Dictionary = {
  ...
  projectsNew: {
    ...
    subIndustryOtherOption: "Other (specify)",
    subIndustryOtherPlaceholder: "Specify your line of business",
    regionLabel: "Region",
    stageLabel: "Stage",
    amountLabel: "Amount, soʻm",
    ...
    loginRequiredMessage: "To list a project on the exchange and see investor applications in your account, please sign in or register first.",
    loginCta: "Sign in",
  },
  projectDetail: {
    ...
    contactPlaceholder: "Phone or email to reach you",
  ...
  cabinet: {
    ...
    exportError: "Couldn't prepare the file. Please try again.",
    ...
    viewBusinessPlan: "View",
    hideBusinessPlan: "Hide",
    publicBadge: "On the project exchange",
    applicationsHeading: "Investor applications",
    viewApplications: "View",
    hideApplications: "Hide",
    saveApplications: "Save",
    noApplicationsYet: "No investor applications yet.",
  },
  islamicGuide: {
    eyebrow: "Guide",
