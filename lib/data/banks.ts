...
export type FinancingOffer = {
  ...
  logoDomain?: string;
  /** Ссылка на первоисточник — только у предложений, собранных скрейпером bank.uz. */
  sourceUrl?: string;
  /** Валюта min/maxAmount. Нет — подразумевается UZS (как у всех статичных предложений). */
